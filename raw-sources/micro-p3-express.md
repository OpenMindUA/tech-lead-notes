<!-- chunk: index.md --># micro.P3.express manual
# micro.P3.express
...
## What micro.is P3.express?

micro.P3.express is a flavor of P3.express, adapted for managing micro-projects with 1 to 7 people. These can be humanitarian, cultural, artistic, research, IT, or any other type of project.

micro.P3.express is a minimalist project management method. Being minimalist means that it avoids clutter and complexity by focusing on the essential aspects. Being a method means that it provides a step-by-step approach rather than a set of guidelines.

micro.P3.express is open and free, with a Creative Commons license.

Co-funded by theEuropean Union

## Why micro.P3.express?

Because most micro-projects are run intuitively, and people rediscover how to run them every time. Instead, we can have the repeatable management aspects structured as a project management method and focus our energy on the more unique and creative aspects of the project.

## How does micro.P3.express work?

micro.P3.express has 27 management activities, each with a clear purpose. These activities are divided among different groups, usually cyclical, to make it easier to turn them into a habit and do them more or less automatically.

Instead of having fixed roles, like in P3.express, micro.P3.express uses dynamic hats that represent the coordination concerns, investor concerns, creator (technical) concerns, and user concerns. People in the project can swap these hats at specific activities designed for that purpose so that no one has too many managerial responsibilities.

micro.P3.express is fully described in its [online manual](https://micro.p3.express/manual/v1/).

## Get certified

After learning micro.P3.express (by self-study or with the help of a trainer), you can take the exam to become a certified micro.P3.express Practitioner (µP3P). This exam is focused on your ability to manage projects rather than recalling theoretical information.

[Learn more about the exam](https://micro.p3.express/en/modules/micro.p3.express/certification/)

## Trainer resources and accreditation

As a trainer, you can teach micro.P3.express project management using its [standard slide deck](https://micro.p3.express/en/modules/micro.p3.express/training/standard-slides/) or any other method you like. You don’t need permission to teach micro.P3.express, but if you want, you can apply to [become accredited](https://micro.p3.express/en/accreditation/).

The accreditation programs are free of charge and only focused on ensuring the quality of training programs.
...
[LinkedIn](https://www.linkedin.com/company/101128376/)[Email](https://micro.p3.express/subscribe.php)[RSS](https://micro.p3.express/en/index.xml)
...
- [All announcements...](https://micro.p3.express/en/announcements/)
...
<!-- chunk: 01-identify-the-high-level-decision-maker-s.md --># A1 — Identify the high-level decision maker(s)
...
<!-- chunk: 02-understand-and-distribute-the-hats.md --># A2 — Understand and distribute the hats
...
<!-- chunk: 03-select-tools-and-create-a-project-repository.md --># A3 — Select tools and create a project repository
...
The repository can be a directory on a *cloud storage* platform or a local network that is synchronized and made available offline on team members’ computers. Alternatively, computer-savvy people can use *Git* and similar technologies to set up their repositories.
...
[A2](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/a/2/ "previous activity")
[A4](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/a/4/ "next activity")

<!-- chunk: 04-create-a-common-understanding.md --># A4 — Create a common understanding
...
<!-- chunk: 05-have-project-initiation-peer-reviewed.md --># A5 — Have Project Initiation peer-reviewed
...
<!-- chunk: 06-make-a-go-no-go-decision.md --># A6 — Make a go/no-go decision
...
<!-- chunk: 07-conduct-a-focused-communication.md --># A7 — Conduct a focused communication
# A7 – Conduct a focused communication

This management activity belongs to the **Project Initiation** group. This group of activities are run at the beginning to prepare us for the project.

This is the last management activity in the *Project Initiation* group, required when the organization is larger than the project team.

Project Manager Hat

Does the rest of the organization know we're going to start this project?

Everyone in the organization should be aware of the project so that they can align themselves with it and support it as needed. It also helps identify potential conflicts and opportunities at the earliest possible time.

In this activity, the person wearing the *Project Manager* hat sends a short message to everyone in the organization, letting them know the project is going to start and explaining its goal and desired outcomes.

[A6](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/a/6/ "previous activity")
[C1](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/c/1/ "next activity")

<!-- chunk: index.md --># Group C — Weekly Initiation
# Group C — Weekly Initiation

See individual activity pages.

<!-- chunk: 01-revise-and-refine-the-common-understanding.md --># C1 — Revise and refine the common understanding
...
[A7](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/a/7/ "previous activity")
[C3](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/c/3/ "next activity")

<!-- chunk: 02-have-the-weekly-initiation-peer-reviewed.md --># C2 — Have the Weekly Initiation peer-reviewed
...
<!-- chunk: 03-make-a-go-no-go-decision.md --># C3 — Make a go/no-go decision
...
After this, the person or group responsible for the go/no-go decision (set in [A1](https://micro.p3.express/a/1/)) makes a decision. The decision and its related information are recorded on a card on the *Integrated Project Board*.
...
[C2](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/c/2/ "previous activity")
[C4](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/c/4/ "next activity")

<!-- chunk: 04-conduct-a-focused-communication.md --># C4 — Conduct a focused communication
# C4 – Conduct a focused communication

This management activity belongs to the **Weekly Management** group, which is a group of activities run at the beginning of each week to revise the plans and align for the upcoming week.

This is the end of the *Weekly Initiation* activity group. If the organization is larger than the project team, a focused communication may be necessary.

Project Manager Hat

Do we need to communicate the weekly plan to a broader audience?

Since this is a weekly activity, you should make sure that the frequency of the communications matches the expectations of the stakeholders, and if needed, send them every two or four cycles instead, and send it only to certain people rather than everyone in the organization.

[C3](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/c/3/ "previous activity")
[D1](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/d/1/ "next activity")
...
<!-- chunk: 01-manage-follow-up-items.md --># D1 — Manage follow-up items
...
<!-- chunk: 02-close-completed-deliverables.md --># D2 — Close completed deliverables
...
[D1](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/d/1/ "previous activity")
[E1](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/e/1/ "next activity")

<!-- chunk: index.md --># Group E — Weekly Closure
# Group E — Weekly Closure

See individual activity pages.

<!-- chunk: 01-measure-and-report-performance.md --># E1 — Measure and report performance
...
There’s no simple, universal way of forecasting, and the person wearing the *Project Manager* hat should ensure that an appropriate method is used: one that is good enough for replanning or changing the targets in [C1](https://micro.p3.express/c/1/). New forecasts should be added to the “targets and forecasts” meta-card in the “project description” column of the *Integrated Project Board*.
...
[D2](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/d/2/ "previous activity")
[E2](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/e/2/ "next activity")

<!-- chunk: 02-evaluate-stakeholder-satisfaction.md --># E2 — Evaluate stakeholder satisfaction
...
<!-- chunk: 03-capture-lessons-and-plan-for-improvements.md --># E3 — Capture lessons and plan for improvements
...
<!-- chunk: 04-consider-swapping-hats-for-the-week.md --># E4 — Consider swapping hats for the week
...
Can we increase collaboration by swapping the hats for next week?

It’s usually helpful to redistribute the hats to increase team members involvement and collaboration and improve everyone’s understanding of the project. However, it’s not always possible or desirable.

You need to add the new hat assignments to the “stakeholders” meta-card in the “project description” column of the *Integrated Project Board*.

[E3](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/e/3/ "previous activity")
[F1](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/f/1/ "next activity")
...
<!-- chunk: 01-double-check-and-hand-over-the-final-output.md --># F1 — Double-check and hand over the final output
...
If we need to do more before ending the project, you should return to [C1](https://micro.p3.express/c/1/), and otherwise, to [F2](https://micro.p3.express/f/2/).
...
[E4](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/e/4/ "previous activity")
[F2](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/f/2/ "next activity")

<!-- chunk: 02-evaluate-stakeholder-satisfaction.md --># F2 — Evaluate stakeholder satisfaction
...
<!-- chunk: 03-have-the-project-closure-peer-reviewed.md --># F3 — Have the Project Closure peer-reviewed
...
<!-- chunk: 04-consider-swapping-hats-for-post-project-management.md --># F4 — Consider swapping hats for Post-Project Management
...
<!-- chunk: 05-archive-the-project-documents.md --># F5 — Archive the project documents
# F5 – Archive the project documents

This management activity belongs to the **Project Closure** group. This activity group is done when the product of the project is complete, or when you decide to cancel the project.

The management and production documents generated in the project will be helpful in similar projects you may have in the future. For this reason, it’s important to make sure they stay accessible.

Project Manager Hat

What's the best way of archiving the documents?

Are the files made read-only?
...
Sometimes, the documents are so cryptic that only the writer can understand them for a few weeks after writing. Such documents can’t be helpful in the future, and that’s why it’s important for the person(s) wearing the *Project Manager* hat to continuously ensure that documents are clear and understandable.

[F4](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/f/4/ "previous activity")
[F6](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/f/6/ "next activity")

<!-- chunk: 06-celebrate.md --># F6 — Celebrate
# F6 – Celebrate!
...
<!-- chunk: 07-conduct-a-focused-communication.md --># F7 — Conduct a focused communication
...
<!-- chunk: 01-evaluate-the-benefits.md --># G1 — Evaluate the benefits
...
The *Post-Project* cycle usually repeats every 1 to 6 months for 1 to 5 years, depending on the type of project. In this cycle, we evaluate the benefits of the project’s output to take action and examine our original expectations and learn more.
...
What happened to the expected benefits and disbenefits?

Did we have any unexpected benefits or disbenefits?

Project Manager Hat

Have all the hats been involved in this evaluation?

Have we documented the result of the evaluation properly?

The result is shared with others in [G2](https://micro.p3.express/g/2/) and [G3](https://micro.p3.express/g/3/).

[F7](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/f/7/ "previous activity")
[G2](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/g/2/ "next activity")

<!-- chunk: 02-generate-new-ideas.md --># G2 — Generate new ideas
...
<!-- chunk: 03-conduct-a-focused-communication.md --># G3 — Conduct a focused communication
# G3 – Conduct a focused communication

This management activity belongs to the **post-project management** activity group: a cycle that goes on for 1 to 5 years after the project ends. During that time, the cycle is run every 1 to 6 months.

If there are stakeholders other than the hats involved in the post-project management cycle, we need to inform them of the results.

Project Manager Hat

Who should be informed of the results of the benefits evaluation?

When the organization is larger than the project team, everyone in that organization should be informed of the results of the evaluation within the limits of confidentiality. This is a reminder for everyone of why we do the projects, which is helpful for on-going and future projects.

[G2](https://micro.p3.express/en/modules/micro.p3.express/manual/v1/g/2/ "previous activity")
