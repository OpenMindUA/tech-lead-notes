<!-- chunk: index.md --># Open Guide to Kanban
# Open Guide to Kanban (v2025.7 (July 2025))

Adaptation of The Kanban Guide for hybrid / knowledge-work contexts. © 2019-2025 Orderly Disruption Limited, Daniel S. Vacanti, Inc.. Licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
...
- [Definition of Kanban in the Context of Knowledge Work](02-definition-of-kanban-in-the-context-of-knowledge-work.md)
- [Why Use Kanban?](03-why-use-kanban.md)
- [Kanban Theory](04-kanban-theory.md)
- [Kanban Practices](05-kanban-practices.md)
- [Inform Flow Optimization with Appropriate Measures or Metrics](06-inform-flow-optimization-with-appropriate-measures-or-metrics.md)
- [Endnote](07-endnote.md)
- [History of Kanban](08-history-of-kanban.md)
- [Acknowledgments](09-acknowledgments.md)
- [Appendix](10-appendix.md)
- [References](11-references.md)

Source page: <https://kanbanguides.org/open-guide-to-kanban/>.

<!-- chunk: 01-preface.md --># Preface
## Preface
...
<!-- chunk: 02-definition-of-kanban-in-the-context-of-knowledge-work.md --># Definition of Kanban in the Context of Knowledge Work
...
<!-- chunk: 03-why-use-kanban.md --># Why Use Kanban?
## Why Use Kanban?
...
<!-- chunk: 04-kanban-theory.md --># Kanban Theory
## Kanban Theory
...
<!-- chunk: 05-kanban-practices.md --># Kanban Practices
## Kanban Practices
...
<!-- chunk: 06-inform-flow-optimization-with-appropriate-measures-or-metrics.md --># Inform Flow Optimization with Appropriate Measures or Metrics
...
<!-- chunk: 08-history-of-kanban.md --># History of Kanban
## History of Kanban
...
<!-- chunk: 09-acknowledgments.md --># Acknowledgments
## Acknowledgments
...
<!-- chunk: 11-references.md --># References
## References
...
1. _Little, J. D. C. (1961). A proof for the queuing formula: L = λW. Operations Research, 9(3), 383–387.
   <https://doi.org/10.1287/opre.9.3.383>. _
...
6. *Hopp, W. J. and Spearman, M. L. (2004) ‘To pull or not to pull: what is the question?’, Manufacturing & Service Operations Management, 6(2), pp. 133–148.
...
12. _Wikipedia (2025) ‘Kanban (development)’. Available at:
    [https://en.wikipedia.org/wiki/Kanban_(development)](https://en.wikipedia.org/wiki/Kanban_%28development%29)(Accessed: 22 June 2025)._
13. _Kingman, J. F. C. (1961) ‘The single server queue in heavy traffic’, Mathematical Proceedings of the Cambridge Philosophical Society, 57(4), pp. 902–904. doi: 10.1017/S0305004100035783, and the stable URL is
    <https://www.cambridge.org/core/journals/mathematical-proceedings-of-the-cambridge-philosophical-society/article/single-server-queue-in-heavy-traffic/81C55BC00A68FE6D5385638AA0B0AF37>. _
14. *Roser, C. (2018) ‘The Kingman Formula – Variation, Utilization, and Lead Time’, AllAboutLean.com, 2 March. Available at:
    <https://www.allaboutlean.com/kingman-formula/>(Accessed: 22 June 2025)*
...
17. *Seddon, J. (2019). Failure demand | Vanguard. [online] Vanguard-method.net. Available at:
    <https://vanguard-method.net/library/systems-principles/failure-demand/>[Accessed 22 Mar. 2019]*
...
22. *Gilb, T. (2005) Competitive Engineering: A Handbook for Systems Engineering, Requirements Engineering, and Software Engineering Using Planguage. Oxford: Elsevier Butterworth-Heinemann. Also available at:
