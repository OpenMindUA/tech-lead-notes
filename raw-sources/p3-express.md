...
- A high-level description of in-scope and out-of-scope elements
...
If you’re going to have external suppliers and some of them were selected in [A05](https://p3.express/manual/v2/a/05/), you might want to sign the contract with them at this point. Additional external suppliers may be selected and contracts signed later on an ad hoc basis.
...
If the project has been approved in [A08](https://p3.express/manual/v2/a/08/), it’s time for the customer and supplier stakeholders to get together and start the project with a kick-off event.
...
When you get the approval in [B03](https://p3.express/manual/v2/b/03/), it’s time to have a kick-off meeting for the monthly cycle.
...
If you have any deviations from your targets based on the performance measurements in [C01](https://p3.express/manual/v2/c/01/), you should manage them and try to get back on track.
...
- Don’t use this meeting for checking the performance (That’s done in [C01](https://p3.express/manual/v2/c/01/)).
- Don’t use this meeting to design responses for the identified issues and risks (That’s done in [D01](https://p3.express/manual/v2/d/01/)).
...
- You can only get proper results from a workshop when it’s facilitated properly. You can use techniques such as [Delphi](https://en.wikipedia.org/wiki/Delphi_method) in your facilitation.
...
- Avoid [anchoring](https://en.wikipedia.org/wiki/Anchoring_(cognitive_bias)) people to one or a few ideas, and use a neutral framing for problems.
...
Send a message to all team members telling them about the project achievements during the month and thanking them for their contributions.

## Purpose

It reminds everyone to stay focused on the objectives rather than on isolated specialized activities. When done properly, it helps unify the team.

## Common pitfalls

Having the following in mind will help you avoid the commonest pitfalls:

- Focus on achievements rather than the amount of work done.
- Keep the message clear and avoid corporate talk.
- Keep the message short – preferably just a few lines.
...
- When possible, make sure the archive is in a single place and the files are not scattered.
- Make sure the archive is read-only.
- Make sure there’s a proper backup system in place so the archive won’t be lost.
- Make sure the archive is safe and that only authorized people have access to it.
...
Now, it’s time to have a celebration for the team members, or for the whole organization. After this management activity, the project team will be released.

## Purpose

This is an investment for future projects, as it reminds people that they are all working toward the same goal.

## Common pitfalls

Make sure it’s a memorable and enjoyable event, and not a dry corporate event with long speeches.
...
- It helps us find ways to increase benefits ([G02](https://p3.express/manual/v2/g/02/)).
...
- A vague, wordy description of the benefits doesn’t serve any purpose. The result may be high‑level and probabilistic, but it has to stay meaningful and capable of being used in [G02](https://p3.express/manual/v2/g/02/).
...
After evaluating the benefits ([G01](https://p3.express/manual/v2/g/01/)), the sponsor should check to see whether there are any ways of increasing them. The result may be small activities assigned to the operational teams, or major changes that can become new projects in the future.
