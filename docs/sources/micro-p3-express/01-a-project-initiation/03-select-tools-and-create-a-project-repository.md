---
title: A3 — Select tools and create a project repository
source_id: micro-p3-express
chapter: Project Initiation
chapter_index: 1
section: Select tools and create a project repository
section_index: 3
activity_code: A3
source_url: "https://micro.p3.express/a3/"
source_version: current
license: CC-BY-4.0
authors: PTCoE — Nader K. Rad et al.
tags: [micro-p3-express, a, project-initiation, a3]
---
